...
const ticketOptions: TicketOption[] = [
  {
    id: 'atlantida-frontstage',
    name: 'Atlântida FrontStage',
    price: 250.00,
    checkoutUrl: 'https://seguro.compragarantidas.shop/api/public/shopify?product=2989147278159&store=29891'
  },
  {
    id: 'refugio-atlantida',
    name: 'Refúgio Atlântida',
    price: 500.00,
    checkoutUrl: 'https://seguro.compragarantidas.shop/api/public/shopify?product=2989138499899&store=29891'
  }
];

export default function TicketSelector() {
  const [quantities, setQuantities] = useState<Record<string, number>>({
    'atlantida-frontstage': 0,
    'refugio-atlantida': 0
  });
